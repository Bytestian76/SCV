            ...
            return `
                <tr>
                    <td>
                        ...
                        <div class="cell-sub">${c.total_items || 0} ${itemLabel} verificados</div>
                    </td>
                    <td>
                        <div style="font-weight: 500; color: var(--text-main);">${c.vehiculo?.placa || 'Sin placa'}</div>
                        <div class="cell-sub">Km: ${c.kilometraje || 0}</div>
                    </td>
                    <td>
                        <div>${c.conductor?.nombre || 'Sin conductor'}</div>
                    </td>
                    <td>
                        <div>${c.usuario?.nombre || 'N/A'}</div>
                    </td>
                    <td>
                        <div class="table-actions">
                            <button class="btn-icon" title="Ver Detalles" data-action="ver" data-id="${c.id}">
...
function handleChequeosListClick(e) {
    ...
    if (action === 'ver' || action === 'view-chequeo') {
